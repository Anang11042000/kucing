...
Isadmin=$(curl -sS https://raw.githubusercontent.com/Anang11042000/Izin/main/vps | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/Anang11042000/Izin/main/vps | grep $MYIP | awk '{print $3}')
fi
...
echo -e "└──────────────────────────────────────────┘" | lolcat
echo -e "\033[1;96m  Owner        : ANANG VPN \e[0m"
