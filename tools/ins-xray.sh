...
wget -q -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/Anang11042000//kucing/main/tools/nginx.conf" 
#mkdir -p /home/vps/public_html
wget -q -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/Anang11042000//kucing/main/tools/vps.conf"
